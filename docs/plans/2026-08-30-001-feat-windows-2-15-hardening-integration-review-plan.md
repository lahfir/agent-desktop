...
| R16 | U1 scenario 8 — the contract sentence and both fidelities are in `docs/phases.md`, and A14-8's no-propagation ban is restated as binding on both adapters | U1 |
