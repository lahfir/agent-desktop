...
function Get-E2ERuleTable {
    ...
    return @(
        ...
        [pscustomobject]@{ Id = 'rule15'; Name = 'a leg does not measure something and discard it'; ScopeFilter = { param($rel) $rel -match '^scenarios/' }; Test = { param($p) Test-Rule15MeasuredAndDiscarded -Parsed $p } }
