...
/// Matches the ceiling the configuration applies before a label is ever sent.
/// Restated rather than imported because core keeps its own copy private, and
/// making it public would widen a shared API for one platform's reading side.
