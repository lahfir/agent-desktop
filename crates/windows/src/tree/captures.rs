...
//!
//! Sub-phase 2.3's dogfood censuses are deliberately **not** committed and so
//! are not listed here. They run to thousands of lines of JSON, they are
//! regenerated on demand by `probes/windows/scratch/run-dogfood.ps1`, and
//! everything a later reader needs from them - the findings, the per-target
//! judgements, the coverage numbers - is written up in the report under
